...
architecture rtl of audio_filter is
    ...
    type coeff_mux_array is array (0 to 16) of std_logic_vector(15 downto 0);
    signal active_coeff : coeff_mux_array;
...
begin
    ...
    coeff_mux : for n in 0 to 16 generate
        active_coeff(n) <= LP_COEFF(n) when switch_reg = '0' else HP_COEFF(n);
    end generate coeff_mux;
