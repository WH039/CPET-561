...
module nios_system_mm_interconnect_0 (
		...
		input  wire        inferred_ram_be_0_reset_reset_bridge_in_reset_reset, // inferred_ram_be_0_reset_reset_bridge_in_reset.reset
	...
	wire  [15:0] pushbutton_s1_agent_m0_address;                                                     // pushbutton_s1_agent:m0_address -> pushbutton_s1_translator:uav_address
	...
	wire  [92:0] pushbutton_s1_agent_rf_source_data;                                                 // pushbutton_s1_agent:rf_source_data -> pushbutton_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] pushbutton_s1_agent_rsp_fifo_out_data;                                              // pushbutton_s1_agent_rsp_fifo:out_data -> pushbutton_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pushbutton_s1_agent:cp_data
	...
	wire  [91:0] pushbutton_s1_agent_rp_data;                                                        // pushbutton_s1_agent:rp_data -> router_008:sink_data
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                           //                      clk.clk
		.reset                  (inferred_ram_be_0_reset_reset_bridge_in_reset_reset),     //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                                     //             clk.clk
		.reset                   (inferred_ram_be_0_reset_reset_bridge_in_reset_reset),               //       clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                               // in_clk_0.clk
		.in_rst_0_reset (inferred_ram_be_0_reset_reset_bridge_in_reset_reset),         // in_rst_0.reset
